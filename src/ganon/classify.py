...
def classify(cfg):
    ...
    for db_prefix in cfg.db_prefix:
        if check_file(db_prefix + ".ixf"):
            filter_files.append(db_prefix + ".ixf")
        else:
            print_log("File not found: " + db_prefix + ".ixf")
            return False

        if check_file(db_prefix + ".stashmap"):
            stashmap_files.append(db_prefix + ".stashmap")
    ...
    stashmap_files = ",".join(stashmap_files)
    ...
    run_ganon_classify = " ".join(
        [
            ...
            "--ixf " + filter_files,
            "--stashmap " + stashmap_files if stashmap_files else "",
